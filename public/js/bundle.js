...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</dip>");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHJhbnR1IiwiYSI6ImNrNjN3ZXppazBxeWEzbG1tbHN1NnkweWcifQ.-2TikldHPvz4ww1Zdw6RMQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/trantu/ck64mtahq1sca1io7pr1u20qd',
    scrollZoom: false // center: [106.666328, 10.786345],
    // zoom: 10,
    // interactive: false
...
var stripe = Stripe('pk_test_zh7g6ZTRMTjBVK9HBUvTTlJb00CTvA4zvG');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(userDataForm); // form.append('name', document.getElementById('name').value);
    ...
    regeneratorRuntime.mark(function _callee2(e) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              bookTourBtn.innerHTML = 'Processing...';
...
},{"./login":"login.js","./mapbox":"mapbox.js","./stripe":"stripe.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
